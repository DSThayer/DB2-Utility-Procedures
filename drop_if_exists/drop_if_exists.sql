...
---------------------------------------------------------------------------------------------------
--
--A utility to drop a table if it exists, or fail silently if it does not exist.
--
--usage:
--
--call fnc.drop_if_exists('schema.tablename')


drop specific procedure fnc.drop_if_exists!
create procedure fnc.drop_if_exists (
	tabname VARCHAR(1000)
)
specific fnc.drop_if_exists
modifies sql data
language sql
begin
